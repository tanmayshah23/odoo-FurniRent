              ...
              <Box marginTop="20px">
                <Flex>
                  ...
                  <Box width="40%">
                    <Image
                      width="100%"
                      src="https://www.FurniRent.com/public/images/product/app-benefits/product.png"
                    />
                  </Box>
                </Flex>
              </Box>
                ...
                <Flex>
                  ...
                  >
                    <Image
                      width="60%"
                      height="60px"
                      src="https://www.FurniRent.com/public/images/product/app-benefits/icons/common/relocation.svg"
                    />
                  </Box>
                ...
                <Flex>
                  ...
                  >
                    <Image
                      width="60%"
                      height="60px"
                      src="https://www.FurniRent.com/public/images/product/app-benefits/icons/furniture/1.png"
                    />
                  </Box>
                  <Box paddingLeft="10px" textAlign="left">
                ...
                <Flex>
                  ...
                  >
                    <Image
                      width="60%"
                      height="60px"
                      src="https://www.FurniRent.com/public/images/product/app-benefits/icons/furniture/2.png"
                    />
                  </Box>
                  <Box paddingLeft="10px" textAlign="left">
                    <Text fontWeight="500">
                ...
                <Flex>
                  ...
                  >
                    <Image
                      width="60%"
                      height="60px"
                      src="https://www.FurniRent.com/public/images/product/app-benefits/icons/common/1.png"
                    />
                  </Box>
                  <Box paddingLeft="10px" textAlign="left">
                    <Text fontWeight="500">
                ...
                <Flex>
                  ...
                  >
                    <Image
                      width="60%"
                      height="60px"
                      src="https://www.FurniRent.com/public/images/product/app-benefits/icons/furniture/5.png"
                    />
                  </Box>
                  <Box paddingLeft="10px" textAlign="left">
                    <Text fontWeight="500">
              ...
              >
                ...
                >
                  ...
                  <Text fontSize="14px" marginTop="5px">
                    RMI is a short form for FurniRent Monthly Installments which
                ...
                >
                  ...
                  <Text fontSize="14px" marginTop="5px" color="gray.500">
                    ...
                    today shifts once in 2 years. FurniRent saves you from this
                            ...
                            <Flex justifyContent="space-between">
                              <Box>
                                <Flex alignItems="center" gap="10px">
                                  ...
                                  <a href="https://FurniRentdesk.freshdesk.com/support/home">
                                    <Button
