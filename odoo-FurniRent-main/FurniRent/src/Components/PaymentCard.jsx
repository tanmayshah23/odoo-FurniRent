                    ...
                    >
                      <Flex alignItems="center" justifyContent="space-around">
                        {/* <Button>
                          <Image
                            cursor="pointer"
                            src="https://www.FurniRent.com/public/images/cart/payment/razorpay.png"
                            w="20%"
                            h="60px"
                          />
                        </Button> */}
                  ...
                  >
                    ...
                    >
                      <Flex alignItems="center" justifyContent="space-around">
                        <Image
                          cursor="pointer"
                          src="https://www.FurniRent.com/public/images/cart/payment/amazon-pay.png"
                          w="20%"
                          h="60px"
                        />
                    ...
                    >
                      <Flex alignItems="center" justifyContent="space-around">
                        <Image
                          cursor="pointer"
                          src="https://www.FurniRent.com/public/images/cart/payment/mobikwik.png"
                          w="20%"
                          h="60px"
                        />
                        <Text cursor="pointer" fontSize="15px">
